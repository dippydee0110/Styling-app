...
export default function ModelCanvas({ model, cartItems, onSlotClick, onRemoveSlot }: Props) {
      ...
      >
        {model ? (
          <>
            ...
            <img src={model.imageUrl} alt="Generated AI styling model" className="h-full w-full object-cover" />
